...
<div class="row">
    ...
    <form id="dijkstra-form" class="lead2">
        ...
        <br>
        <input type="button" value="Создать таблицу" class="custom-button2" onclick="createMatrixTable()">
                <br>        <br>
        ...
        <input type="button" value="Найти кратчайшие пути" class="custom-button2" onclick="findShortestPaths()">
    </form>
